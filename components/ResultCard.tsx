...
import { Copy, Check, Palette, Type as TypeIcon, Droplet, WholeWord, Hash, Search } from 'lucide-react';
...
const ResultCard: React.FC<Props> = ({ prompt, index }) => {
